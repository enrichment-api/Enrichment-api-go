# [<img src="https://app.tomba.io/logo.svg" alt="Tomba" width="25"/>](https://tomba.io/) Company and Emails Enrichment API go


This is the official Go client library for the [Tomba.io](https://tomba.io) Company and Emails Enrichment API go
,
allowing you to:
...
get email addresses found on the internet and company informations .
